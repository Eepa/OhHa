...
/**
 * Luokka PiirtoPanel lisää Neljansuora-pelin graafiseen käyttöliittymään
 * piirtopaneelin ja nappulat, joiden avulla pelaajat tekevät siirtojaan.
 *
...
public class PiirtoPanel extends JPanel {
    ...
    /**
     * Konstruktori luo PiirtoPaneelille uuden layoutin ja asettaa attribuuttien
     * arvot konstruktorin parametreinä annetuiksi arvoiksi. Konstruktorissa
     * käytetään myös luokan omaa metodia luoOsat, jossa luodaan PiirtoPanelin
     * erilliset osat.
     *
     * @param neljansuora Kuvaa Neljansuora-peliä
     * @param piirtoalusta Kuvaa piirtoalustaa, joka piirtää peliruudukon.
     * @param tilannetietoPanel Kuvaa TilannetietoPanel-luokan ilmentymää, joka
     * kertoo pelitilanteen.
     */
    ...
    /**
     * Metodi luo ja asettaa layouttiin PiirtoPanelin osat, joita ovat
     * Piirtoalusta ja nappularivi, jonka avulla pelaajat tekevät siirtojaan.
     */
