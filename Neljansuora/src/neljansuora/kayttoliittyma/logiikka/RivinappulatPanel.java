...
/**
 * RivinappulatPanel-luokka luo käyttöliittymään nappularivin, jonka nappuloiden
 * avulla pelaaja voi omalla vuorollaan pudottaa pelilaudalle uuden nappulan.
 *
...
public class RivinappulatPanel extends JPanel {
    ...
    /**
     * Konstruktori luo RivinappulatPanelille uuden layoutin ja asettaa luokan
     * attribuuttien arvot konstruktorin parametrien arvoiksi. Konstruktori myös
     * käyttää luokan omaa metodia luoNappulat(), joka luo paneelille omat
     * nappulat.
     *
     * @param pelilauta Kuvaa Neljansuora-pelin pelilautaa
     * @param tilannetietoPanel Kuvaa TilannetietoPanelia, joka kertoo
     * tilannetiedot pelistä
     */
    ...
    /**
     * Metodi luo ja asettaa layouttiin RivinappulatPanelille uudet nappulat,
     * joiden avulla pelaajat voivat tehdä siirtoja.
     */
    ...
    /**
     * Metodi lisää jokaiselle nappulalle tapahtumankuuntelijan
     * NappulanPudotusListener, joka kertoo, kun nappulaa painetaan. Nappi
     * lisätään samalla RivinappulatPaneeliin.
     *
